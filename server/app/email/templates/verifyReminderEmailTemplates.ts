import { EmailTemplate } from "../../../../types/IEmail";
...
const verifyEmailTemplate = function (
  ...
  const html = `
    ...
    <body
      ...
      <div style="display: none;">This a reminder to verify your ${accountName} account.
  ...
  const text = `
        Reminder to Verify Email, A request to create your ${accountName} account was received.
